...
namespace CocktailPlanner.Controllers
{
    public class IngredientController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdIngredient,Name,Quantity,Unit")] Ingredient ingredient)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdIngredient,Name,Quantity,Unit")] Ingredient ingredient)
        {
